...
spa.model = (function () {
  ...
  var
    ...
    personProto, makePerson, people, initModule, makeCid,
    ...
    //      If the current user is not signed in signed-in, an
    //      anonymous person object is returned.
    //    * get_db()( - return the TaffyDB database of all the person
    //      objects - including the current user -presorted
    //    * get_by_cid( <client_id> ) - returns a person object with
    //      provided unigue id.
    //    * login( <user_name> ) - login as the user with the provided
    //      user name. The current user object is changed to reflect
    //      the new identity. Succesfull completion of login publishes
    //      a 'spa-login' global custom event.
    ...
    //      data is not synced with the server.
    //    * id - the unique id. This may be undefined if object is not
