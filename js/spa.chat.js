...
spa.chat = (function () {
  ...
  setPxSizes = function () {
    ...
    optimized_size_chat
      ...
      - ( configMap.window_height_min_em - window_height_em )
      - 2;

    opened_height_em
      = window_height_em > configMap.window_height_min_em
      ? configMap.slider_opened_em
      : Math.max( optimized_size_chat, configMap.slider_opened_min_em );
  ...
  // Arguments:
  //    * postion_type  - enum('closed', 'opened', or 'hidden')
  //    * callback      - optional callback at end of animation.
  //      The callback receives a jQuery collection representing
  //      the slider div as its single argument.
  // Action   :
  ...
  // Returns  :
  //    * true  - requested position was achieved
  ...
  //    a given threshold, resize the chat slider to the
  //    reduced window size.
  // Returns  : Boolean
  ...
  //        indicate to indicate opened or closed state. This callback
  //        must return false if the requested state cannot be met.
  //    * chat_model      - the chat model object provides methods
  //        to interact with our instant messaging
  //    * people_model    - the people object model which provides
  //        methods to manage list of people the model maintains.
  //    * slider_* setttings. All these are optional scalars.
  //        see mapConfig.settable_map for a full list
  //        Example: slider_open_em is the open height in em's
  // Action :
  //    The internal configuration data structure (configMap) is
  //    updated with provided arguments. No otheractions are taken.
  // Returns    : true
